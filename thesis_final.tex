...
\usepackage{fontawesome5}  % GitHub glyph (\faGithub) for compact repo link in footer
\usepackage{etoc}
...
\fancyfoot[RO]{\tiny Thiago A. de Faria~-- \href{https://github.com/thiagoavadore/thesis_2024-2026_antwerp_thesis_GenAIPracticeVacuum}{\faGithub~thiagoavadore/thesis\_2024-2026\_antwerp\_thesis\_GenAIPracticeVacuum}}
\fancyfoot[LE]{\tiny Thiago A. de Faria~-- \href{https://github.com/thiagoavadore/thesis_2024-2026_antwerp_thesis_GenAIPracticeVacuum}{\faGithub~thiagoavadore/thesis\_2024-2026\_antwerp\_thesis\_GenAIPracticeVacuum}}
...
\clearpage
\input{sections/02_theoretical-background}
\clearpage
\input{sections/03_conceptual-model}
\clearpage
\input{sections/04_methodology}
\clearpage
\input{sections/05_results}
\clearpage
\input{sections/06_artifact}
\clearpage
...
\clearpage
\input{sections/appendix/a_genai-usage}
\clearpage
\input{sections/appendix/b_workbook-instrument}
\clearpage
\input{sections/appendix/c_practitioner-checklists}
\clearpage
\phantomsection
